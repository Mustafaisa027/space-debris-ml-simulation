# IAC26 15-day v5 preregistered confirmation protocol

## Status and scientific boundary

`iac26-15d-v5` is the planned claim-eligible confirmation experiment. Its
half-open collection window is frozen as 2026-08-16T00:17:00Z through
2026-08-31T00:17:00Z. No v5 acquisition may occur before this protocol and its
workflow are merged to `main`. Any change after the first accepted v5 bundle
...
duration or acquisition cadence. v5 changes only the prospective acquisition
...
- The `iac26-15d-v4` design remained an unmerged draft, missed its planned
  2026-08-10 start, was never active on `main`, and produced zero authoritative
  v4 bundles. It is superseded rather than retroactively re-dated.
- v2 and v3 bundles, rows and derived outputs are never pooled, backfilled,
  relabelled or reused as v5 observations. They inform only this prospective
...
- Experiment ID: `iac26-15d-v5`.
- Window: `[2026-08-16T00:17:00Z, 2026-08-31T00:17:00Z)`.
...
- Archive: immutable manifest-schema-3 bundles only, beneath
  `experiments/iac26-15d-v5/collections/` on `data-collection`.
...
After 2026-08-31T00:17:00Z, finalization runs strictly in this order:
