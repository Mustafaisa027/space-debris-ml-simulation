...
> Active protocol: `iac26-15d-v4`, 2026-08-10T00:17:00Z through
> 2026-08-25T00:17:00Z. Bundles use manifest schema 3 and are stored beneath
> `experiments/iac26-15d-v4/collections/`. The older root-level
...
> imported into v4. See `docs/EXPERIMENT_15D_V4.md` for the frozen scientific
> contract.
...
```text
experiments/iac26-15d-v4/collections/github-run-RUN_ID-attempt-ATTEMPT/
  experiment/config.json
  history/conjunction_observations_iac26_75_v4.csv
...
Every claim-eligible v4 bundle uses manifest schema 3. Manifest generation
...
compatibility path; the v4 workflow never produces or imports those schemas.
...
members of the v4 cohort. The v4 scientific-progress report records both
...
`experiment_15_days_v4.json`. Existing byte-identical files are an idempotent
...
`config/experiment_15_days_v4.json` as `2026-08-10T00:17:00Z` through
`2026-08-25T00:17:00Z`. Scheduled invocations outside that window exit
...
v4 start, `2026-08-10T00:17:00Z`; a delayed
