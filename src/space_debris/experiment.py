...
# Active prospective confirmation experiment. v4 keeps prior cohorts isolated
...
# as claim-eligible inputs for the independent v4 confirmation run.
ACTIVE_EXPERIMENT_CONFIG = Path("config/experiment_15_days_v4.json")
